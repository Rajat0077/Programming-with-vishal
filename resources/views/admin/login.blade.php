...
<br>
<h2 style="color:red;">
   <u>{ {{ Config::get('constants.site_name') }} } </u> 
</h2>
...
<!-- Below Action and this type action i.e. route('admin.auth') we can use Both Not An Issue -->
    ...
    {{ csrf_field() }}
        ...
        <input class="au-input au-input--full" type="text" name="password" placeholder="Password" required>
        </div>
        ...
        <div class="alert alert-danger" role="alert">
            {{ session('error') }}   <!-- Called For Session Message For Error !!! -->
        </div>
        <?php }
         ?>
    </form>
